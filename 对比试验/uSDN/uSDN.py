...
parser.add_argument('--maxiter', default=50000, type=int, help='max training iterations.')
#toy_sacle
parser.add_argument('--toy_scale', default=16, type=int, help='toy data scale')
...
def main():
    ...
    data = readData(file_content, num, toy_scale=args.toy_scale)
    ...
    # print path
    auto.generate_hrhsi(save_dir=save_path, dir_name=load_path)
