...
# parser.add_argument('--data_name',type=str, default="AISA_3",help='name of your data and spectral response. houston18 is given as a example')#
# parser.add_argument('--data_name',type=str, default="AISA_31",help='name of your data and spectral response. houston18 is given as a example')#
# parser.add_argument('--data_name',type=str, default="stuffed_toys_ms",help='name of your data and spectral response. houston18 is given as a example')#
# parser.add_argument('--data_name',type=str, default="chart_and_stuffed_toy_ms",help='name of your data and spectral response. houston18 is given as a example')#
# parser.add_argument('--data_name',type=str, default="Chikusei",help='name of your data and spectral response. houston18 is given as a example')#
